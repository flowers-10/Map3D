...
// 杭州的边界范围
const hzBoundaries:turf.Position[] = HangZhou.features[0].geometry.coordinates[0][0];

function generateUniformPoints(count: number, boundaries: turf.Feature<turf.Polygon>): turf.Position[] {
