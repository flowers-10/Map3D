...
// Imports adjusted to point to threejs-demo
import {
  LilGui,
  MapApplication,
  MapControlOptions,
...
const animate1Src = Animate1
const animate2Src = Animate2
let mapControl: MapControlStudy | null = null

onMounted(() => {
  if (canvasRef.value) {
    mapControl = new MapControlStudy(canvasRef.value, {
